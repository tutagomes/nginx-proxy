...
You can also set custom Body Sizes with and environment variable called `VIRTUAL_BODY_SIZE`, specifying the value with default format. Per default, it will fallback with 1MB.
